<div class="content__inner">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo site_url('groups/add')?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">                    
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="grp_description" class="form-control is-valid" placeholder="Enter Group Description ..."></textarea>
                            <i class="form-group__bar"></i>
                        </div>
                    </div>
