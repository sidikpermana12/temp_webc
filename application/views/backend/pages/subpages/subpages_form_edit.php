                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="sub_pgs_id" value="<?=$subpages['sub_pgs_id']?>">
                            <input type="text" name="sub_pgs_name" value="<?=$subpages['sub_pgs_name']?>"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="imagessubpages" value="<?=$subpages['sub_pgs_images']?>">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="sub_pgs_body" class="form-control is-valid" placeholder="Enter Description Sub Pages ..."><?=$subpages['sub_pgs_body']?></textarea>
                            <i class="form-group__bar"></i> 
                        </div>
                    </div>
