        ...
        <div class="card-body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <?php if($posts['pst_categoriespost_id'] == '5') {?>
                        <div id="5" class="voh col-sm-6" >
                            <div class="form-group">
                                <label>Link</label>
                                <input type="text" name="pst_link" value="<?=$posts['pst_link']?>" class="form-control is-valid" placeholder="Input Your Link ...">
