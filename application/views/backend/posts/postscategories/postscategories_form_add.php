<div class="content__inner">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo site_url('postscategories/add')?>" method="post" enctype="multipart/form-data">

                <div class="row">                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Posts Categories Name <a style="color: red;">*</a></label>
                            <input type="text" name="cat_pst_name"
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="cat_pst_body" class="form-control is-valid" placeholder="Enter Posts Categories Description ..."></textarea>
                            <i class="form-group__bar"></i>
                        </div>
                    </div>
