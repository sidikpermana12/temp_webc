<div class="content__inner">
    <header class="content__title">
        <a href="<?=site_url('icon-bar')?>" type="button" class="btn btn-primary"><i class="zmdi zmdi-format-list-bulleted"></i> Brand Logo</a>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo site_url('brandlogo/add')?>" method="post" enctype="multipart/form-data">

                <div class="row">

                    <div class="col-sm-6">
                        <div class="form-group">
                            <input type="text" name="lbl_name" class="form-control is-valid">
