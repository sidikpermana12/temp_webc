<!-- ********** Hero Area Start ********** -->
<div class="hero-area height-600 bg-img background-overlay" style="background-image: url(<?=base_url()?>assets/backend/img/pages/<?=$pagesview['pgs_images']?>);">
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="single-blog-title text-center">
                    <h3><?=$pagesview['pgs_name']?></h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="single-blog-content mb-100">
                    ...
                    <div class="post-content">
                        <h6><?=$pagesview['pgs_body']?></h6>
                        <!-- Post Meta Keywords-->
                        <meta name="keywords" content="<?=$pagesview['pgs_name']?>">
                    </div>
                </div>
            </div>
